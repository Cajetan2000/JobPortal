  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 md:py-20 py-14 px-4">
      <h1 className="text-5xl font-bold text-primary mb-3">
        By <span className="text-wine">Ashesi</span> for <span className="text-wine">Ashesi</span> today
      </h1>
      <p className="text-lg text-black/70 mb-8">
        Find jobs on campus in computer, engineering and technology sectors
        are waiting for you.
      </p>
